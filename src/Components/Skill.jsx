...
const Skill = () => {
  ...
  >
    ...
    {skill.name === 'React' ? (
      <Lottie animationData={React} className="h-15 w-15  rounded-md" />
    ) : skill.name === 'Html' ? (
      <Lottie animationData={Html} className="h-15 w-15 rounded-md" />
    ) : skill.name === 'Css' ? (
      <Lottie animationData={Css} className="h-15 w-15 rounded-md" />
    ):skill.name === 'Next.js' ? (
      <Lottie  loop={true} animationData={Next} className="h-15 w-15 rounded-md" />
    ):skill.name === 'JavaScript' ? (
      <Lottie  animationData={JavaSc} className="h-15 w-15 rounded-md" />
    ):(
      <img src={skill.icon} alt={skill.name} className="h-15 w-15 rounded " />
    )}
